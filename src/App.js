    ...
    <>
      <div className='container'>
        ...
        <div className='center'>
            <button disabled={loading} className='btn' style={{textAlign: "center"}} onClick={handelClickGame} >{loading ? "Loading..." : "Random game"}</button>
        </div>
      </div>

      {/* <GameInfo /> */}
      {/* {isVisible === true ? <GameInfo game={game} /> : ""} */}
